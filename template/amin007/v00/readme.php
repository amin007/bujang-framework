...
<!-- ========================================================================================== -->
	<div class="text-center mb-5">
		<h1 class="display-4 text-success fw-bold">7 ADA SOLUTION</h1>
		<p class="lead text-muted">Penyelesaian Lengkap untuk Keperluan Perniagaan dan Kehidupan Anda</p>
		<hr class="my-4">
	</div><!-- /  class="container my-5" -->
<!-- ========================================================================================== -->
	<div class="row mb-5">
	<div class="col-12">
		...
		<h3 class="card-title text-success mb-4">Tentang Kami</h3>
		<p class="card-text">
		7 ADA SOLUTION merupakan sebuah syarikat yang menyediakan pelbagai jenis perkhidmatan dan produk berkualiti tinggi untuk memenuhi keperluan pelanggan kami. Dengan pengalaman bertahun-tahun dalam industri, kami komited untuk memberikan perkhidmatan terbaik dan produk yang berkualiti kepada semua pelanggan kami.
		</p><!-- / class="card-text" -->
		<p class="card-text">
		Kami beroperasi dalam pelbagai bidang perniagaan termasuk teknologi maklumat, peralatan elektronik, buku dan alat tulis, serta produk makanan tradisional. Kepelbagaian perkhidmatan kami membolehkan pelanggan mendapatkan semua keperluan mereka di satu tempat.
		</p><!-- / class="card-text" -->
		</div><!-- /  class="card-body p-5" -->
		</div><!-- / class="card border-success shadow-lg" -->
	</div><!-- / class="col-12" -->
...
<!-- ========================================================================================== -->
<div class="mb-5">
<h2 class="text-center text-success mb-4">Kedai-Kedai Kami</h2>
    ...
    <div class="col-12">
      <div class="card bg-success text-white shadow-lg">
        <div class="card-body p-5 text-center">
          <h3 class="card-title mb-4">Mengapa Memilih 7 ADA SOLUTION?</h3>
          <div class="row g-4 mt-3">
            <div class="col-md-3 col-sm-6">
              <div class="p-3">
                <i class="bi bi-shield-fill-check display-4 mb-3"></i>
                <h5>Produk Berkualiti</h5>
                <p class="small">Semua produk dipilih dengan teliti untuk memastikan kualiti terbaik</p>
              </div><!-- / -->
            </div>
            <div class="col-md-3 col-sm-6">
              <div class="p-3">
                ...
                <p class="small">Harga yang berpatutan dengan promosi menarik sepanjang tahun</p>
              </div><!-- / -->
            </div>
            <div class="col-md-3 col-sm-6">
              <div class="p-3">
                <i class="bi bi-truck display-4 mb-3"></i>
                <h5>Penghantaran Pantas</h5>
                <p class="small">Perkhidmatan penghantaran ke seluruh Malaysia</p>
              </div><!-- / -->
            </div>
            <div class="col-md-3 col-sm-6">
              <div class="p-3">
                <i class="bi bi-headset display-4 mb-3"></i>
                <h5>Sokongan Pelanggan</h5>
                <p class="small">Pasukan khidmat pelanggan sedia membantu anda</p>
              </div><!-- / -->
            </div><!-- / -->
          </div><!-- / -->
        </div><!-- / -->
...
<!-- ========================================================================================== -->
  <div class="row my-5">
    <div class="col-md-6">
      <div class="card border-success h-100">
        <div class="card-body">
            ...
            Sabtu: 9:00 pagi - 2:00 petang<br>
    ...
    <div class="col-md-6">
      <div class="card border-success h-100">
        <div class="card-body">
          <h4 class="card-title text-success"><i class="bi bi-telephone-fill"></i> Hubungi Kami</h4>
          <p class="card-text">
            <strong>Telefon:</strong> 013-1234567<br>
            <strong>E-mel:</strong> support@7adasolution.com<br>
            <strong>Faks:</strong> 06-9876543
          </p>
    ...
    <div class="col-12">
      <div class="card border-success">
        <div class="card-body p-4">
          <h4 class="card-title text-success text-center mb-4"><i class="bi bi-envelope-fill"></i> Borang Pertanyaan</h4>
          <form>
            <div class="row g-3">
              <div class="col-md-6">
...
<div class="text-center my-5 p-4 bg-light rounded">
    <p class="mb-0 text-muted">
      ...
      <a href="#" class="text-success text-decoration-none">Dasar Privasi</a> |
      <a href="#" class="text-success text-decoration-none">Terma & Syarat</a>
    </p>
</div><!-- / -->
<!-- ========================================================================================== -->
</div><!-- / class="container my-5" -->
