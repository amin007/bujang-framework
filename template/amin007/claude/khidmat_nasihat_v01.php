	...
	<div class="bg-success text-white py-5">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-8">
					<h1 class="display-4 fw-bold mb-3"><i class="fa-solid fa-code me-3"></i>Khidmat Nasihat Perisian</h1>
					<p class="lead">Nasihat pembangunan sistem, integrasi dan penyelesaian teknologi.</p>
				</div><!-- / class="col-lg-8" -->
			</div><!-- / class="row align-items-center" -->
		</div><!-- / class="container" -->
	</div><!-- / class="bg-success text-white py-5" -->
