	...
	<div class="bg-success text-white py-5">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-8">
					<h1 class="display-4 fw-bold mb-3"><i class="fa-solid fa-code me-3"></i>Penyelidikan dan Pembangunan & AI</h1>
					<p class="lead">Pembangunan penyelesaian AI dan automasi untuk pelbagai industri.</p>
				</div><!-- / class="col-lg-8" -->
			</div><!-- / class="row align-items-center" -->
		</div><!-- / class="container" -->
	</div><!-- / class="bg-success text-white py-5" -->
			...
			<div class="col-md-6">
				<div class="card h-100 border-success">
					<div class="card-header bg-success text-white">
						<h5 class="mb-0"><i class="fa-solid fa-globe me-2"></i>...</h5>
					</div><!-- / class="card-header bg-success text-white" -->
					<div class="card-body">
						</ul>
					</div><!-- / class="card-body" -->
...
<!-- ========================================================================================== -->
			...
			<div class="col-md-6">
				<div class="card h-100 border-success">
					<div class="card-header bg-success text-white">
						<h5 class="mb-0"><i class="fa-solid fa-mobile-screen me-2"></i>...</h5>
					</div><!-- / class="card-header bg-success text-white" -->
					<div class="card-body">
...
<!-- ========================================================================================== -->
			...
			<div class="col-md-6">
				<div class="card h-100 border-success">
					<div class="card-header bg-success text-white">
						<h5 class="mb-0"><i class="fa-solid fa-chart-line me-2"></i>...</h5>
					</div><!-- / class="card-header bg-success text-white" -->
					<div class="card-body">
						<ul class="list-group list-group-flush">
						</ul>
...
<!-- ========================================================================================== -->
			...
			<div class="col-md-6">
				<div class="card h-100 border-success">
					<div class="card-header bg-success text-white">
						<h5 class="mb-0"><i class="fa-solid fa-plug me-2"></i>...</h5>
					</div><!-- / class="card-header bg-success text-white" -->
					<div class="card-body">
						<ul class="list-group list-group-flush">
						</ul>
