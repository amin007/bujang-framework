...
<div class="col-12">
	...
	<div class="card-body p-5 text-center">
		<!-- ========================================================================================== -->
		<h3 class="card-title text-success fw-bold mb-4">Mengapa Memilih 7 ADA SOLUTION?</h3>
		<div class="row g-4 mt-3">
			<!-- ========================================================================================== -->
			<div class="col-md-3 col-sm-6">
			<div class="p-3">
			<i class="bi bi-shield-fill-check display-4 mb-3 text-success"></i>
			...
			<div class="col-md-3 col-sm-6">
			<div class="p-3">
			<i class="bi bi-headset display-4 mb-3 text-success"></i>
...
<div class="col-md-6">
	...
	<div class="card-body">
		<h4 class="card-title text-success">
			<i class="bi bi-telephone-fill"></i> Hubungi Kami Di <strong>Media Sosial:</strong>
		</h4>
