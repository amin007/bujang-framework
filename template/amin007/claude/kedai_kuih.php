...
<div class="modal-content">
	...
	<div class="modal-body">
		...
		<span>Harga:</span><strong class="text-success fs-5">RM 38.00/balang</strong>
		</div><!-- / class="d-flex justify-content-between align-items-center mb-3" -->
		<div class="mb-3">
...
</div><!-- / class="modal fade" id="beliSekarang???" -->
...
<div class="modal-content">
	...
	<div class="modal-body">
		...
		<div class="d-flex justify-content-between align-items-center mb-3">
			<span>Harga:</span><strong class="text-success fs-5">RM 89.00</strong>
		</div><!-- / class="d-flex justify-content-between align-items-center mb-3" -->
		<!-- ========================================================================================== -->
		<div class="mb-3">
...
<div class="modal-content">
	...
	<div class="modal-body">
		...
		<div class="d-flex justify-content-between align-items-center mb-3">
			<span>Harga:</span><strong class="text-success fs-5">RM 25.00</strong>
		</div><!-- / class="d-flex justify-content-between align-items-center mb-3" -->
		<!-- ========================================================================================== -->
		<div class="mb-3">
...
<div class="modal-content">
	...
	<div class="modal-body">
		...
		<div class="d-flex justify-content-between align-items-center mb-3">
			<span>Harga:</span><strong class="text-success fs-5">RM 12.00</strong>
		</div><!-- / class="d-flex justify-content-between align-items-center mb-3" -->
		<!-- ========================================================================================== -->
		<div class="mb-3">
...
<div class="modal-content">
	...
	<div class="modal-body">
		...
		<div class="d-flex justify-content-between align-items-center mb-3">
			<span>Harga:</span><strong class="text-success fs-5">RM 45.00/kg</strong>
		</div><!-- / class="d-flex justify-content-between align-items-center mb-3" -->
		<!-- ========================================================================================== -->
		<div class="mb-3">
...
<div class="modal-content">
	...
	<div class="modal-body">
		...
		<div class="d-flex justify-content-between align-items-center mb-3">
			<span>Harga:</span>	<strong class="text-success fs-5">RM 30.00</strong>
		</div><!-- / class="d-flex justify-content-between align-items-center mb-3" -->
		<!-- ========================================================================================== -->
		<div class="mb-3">
