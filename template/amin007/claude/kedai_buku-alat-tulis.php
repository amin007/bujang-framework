...
<span>Harga:</span>
<strong class="text-success fs-5">RM 49.90</strong>
</div>
<div class="mb-3">
...
<option value="fizikal" selected>Buku fizikal (RM 59.90)</option>
...
<div class="d-flex justify-content-between align-items-center mb-3">
<span>Harga:</span>
<strong class="text-success fs-5">RM 29.90</strong>
</div>
<div class="mb-3">
...
<div class="d-flex justify-content-between align-items-center mb-3">
<span>Harga:</span>
<strong class="text-success fs-5">RM 24.90</strong>
</div>
<div class="mb-3">
...
<div class="d-flex justify-content-between align-items-center mb-3">
<span>Harga:</span>
<strong class="text-success fs-5">RM 79.90</strong>
</div>
<div class="mb-3">
...
<div class="d-flex justify-content-between align-items-center mb-3">
<span>Harga:</span>
<strong class="text-success fs-5">RM 149.00</strong>
</div>
<div class="mb-3">
<label for="bingkai6" class="form-label">Jenis bingkai:</label>
<select class="form-select" id="bingkai6">
<option value="aluminium" selected>Aluminium (RM 149)</option>
